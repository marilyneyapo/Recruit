...
class __TwigTemplate_f22163ac296175344411efebb62e1217 extends Template
{
...
";
            ...
            foreach ($context['_seq'] as $context["flag_code"] => $context["country_name"]) {
                ...
                if ((isset($context["show_name"]) || array_key_exists("show_name", $context) ? $context["show_name"] : (function () { throw new RuntimeError('Variable "show_name" does not exist.', 26, $this->source); })())) {
                    // line 27
                    yield (((array_key_exists("country_name", $context) &&  !(null === $context["country_name"]))) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($context["country_name"], "html", null, true)) : (""));
                }
                // line 29
                yield "</span>
    ";
...
{% else %}
    ...
    {% endfor %}
{% endif %}
", "@EasyAdmin/crud/field/country.html.twig", "C:\\Users\\LENOVO\\Documents\\Stage\\Recruitment\\vendor\\easycorp\\easyadmin-bundle\\templates\\crud\\field\\country.html.twig");
    }
}
