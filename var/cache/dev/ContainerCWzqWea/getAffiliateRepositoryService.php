 ...
 */
class getAffiliateRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AffiliateRepository' shared autowired service.
     *
     * @return \App\Repository\AffiliateRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AffiliateRepository.php';

        return $container->privates['App\\Repository\\AffiliateRepository'] = new \App\Repository\AffiliateRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
