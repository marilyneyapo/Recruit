 ...
 */
class getVichUploader_Listener_Upload_JobLogosService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.upload.job_logos' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.upload.job_logos'])) {
            return $container->privates['vich_uploader.listener.upload.job_logos'];
        }

        return $container->privates['vich_uploader.listener.upload.job_logos'] = new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('job_logos', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? self::getVichUploader_MetadataReaderService($container)), $a);
    }
}
