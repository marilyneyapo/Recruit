...
class getAdminNotificationServiceService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $f = new \Symfony\Component\Notifier\Notifier(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
        ...
        $f->addAdminRecipient(new \Symfony\Component\Notifier\Recipient\Recipient('marilyneyapo@stratos-co.com', ''));

        return $container->privates['App\\Service\\AdminNotificationService'] = new \App\Service\AdminNotificationService($f, ($container->privates['App\\Repository\\UserRepository'] ?? $container->load('getUserRepositoryService')), ($container->privates['App\\Repository\\CandidatRepository'] ?? $container->load('getCandidatRepositoryService')), new \Symfony\Component\Mailer\Mailer($a, $b, $c), $d, $e, ($container->privates['monolog.logger'] ?? $container->load('getMonolog_LoggerService')));
    }
}
