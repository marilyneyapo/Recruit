...
class Category extends \App\Entity\Category implements \Doctrine\ORM\Proxy\InternalProxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        "\0".parent::class."\0".'affiliates' => [parent::class, 'affiliates', null],
        "\0".parent::class."\0".'id' => [parent::class, 'id', null],
        "\0".parent::class."\0".'jobs' => [parent::class, 'jobs', null],
        "\0".parent::class."\0".'name' => [parent::class, 'name', null],
        "\0".parent::class."\0".'questions' => [parent::class, 'questions', null],
        'affiliates' => [parent::class, 'affiliates', null],
        'id' => [parent::class, 'id', null],
        'jobs' => [parent::class, 'jobs', null],
